...
pixi global install scikit-sparse
```
...
It is possible to list all of the versions of `scikit-sparse` available on your platform:
...
```
pixi search scikit-sparse --channel conda-forge
```
